  ...
  return (
    <>
      <header className=" bg-white flex dark:bg-darkGrey">
        ...
        {theme=== "light" ? 
        (<img className="p-7" src="src/assets/logo-dark.svg"alt="logo"/>) 
        : 
        (<img className="p-7"  src="src/assets/logo-light.svg"alt="logo"/>)
        }
        </div>
        <div className="flex flex-grow items-center justify-between dark:bg-darkGrey ">
          <h1 className="text-xl font-bold text-darkGrey p-4 m-2 dark:text-white">
            Platform Launch
          </h1>
