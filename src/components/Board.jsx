...
export function Board() {
  ...
  const addColumn = () => {
    setColumns((prevColumns) => [
      ...prevColumns,
      <div className="mt-2 flex" key={prevColumns.length}>
          ...
          <div className="border-b border-gray-900/10 pb-4">
            ...
            <div className="mt-5 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
              <div className="sm:col-span-full">
                <label
                  htmlFor="name"
                  className="block text-sm font-bold leading-6 text-mediumGrey"
                >
                  Name
                </label>
                <div className="mt-2">
            ...
            <div className="mt-5 flex flex-col sm:grid-cols-6">
              <div className="sm:col-span-full m-2 ml-0 ">
                <label
                  htmlFor="columns"
                  className="block text-sm leading-6 text-mediumGrey font-bold"
                >
                  Columns
                </label>
              </div>
